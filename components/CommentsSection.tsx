        ...
        return (
          <div key={member.id} className="flex gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-0.5">{member.name}</p>
              ...
              {isEditing ? (
                <div className="space-y-2">
                  <textarea
                    ...
                    rows={3}
                    maxLength={2000}
                    className="w-full px-3 py-2 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-400 resize-none"
                  />
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-medium min-h-11"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <button
                  ...
                  className={`text-sm text-left w-full ${
                    comment ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-500 italic'
